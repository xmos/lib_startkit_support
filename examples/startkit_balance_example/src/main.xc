...
extern void accelerometer(client ball_if, client interface i2c_master_if i2c);
...
int main(void) {
  ...
  par {
    ...
    on tile[0]: accelerometer(i_ball, i2c[0]);

    on tile[0]: i2c_master(i2c, 1, p_scl, p_sda, 250);
